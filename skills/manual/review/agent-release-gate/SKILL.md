...
- Meeting checklist for mapping versions, evidence, hard gates, and `pass` / `warn` / `block` rules: `skills/skills/manual/review/agent-release-gate/references/quick-reference.md`
