...
Running `plan-review` once gives one opinion. Running it in N different coding agents gives N independent opinions you can triangulate.
...
Install `plan-review` globally and invoke it as `/plan-review` in each:

- Claude Code — `~/.claude/commands/plan-review.md`
- Codex / ChatGPT — `~/.codex/prompts/plan-review.md`
- Amp — `~/.agents/skills/plan-review/`
